                                    ...
                                    <tbody>
                                        ...
                                        {{-- <tr>
                                            ...
                                            <td class="py-2 px-1">
                                                ...
                                                {{ __('Credit/Debit Card Online Payment') }}
                                            </td>
                                        </tr> --}}
                                    </tbody>
                                </table>
                                <div class="d-none" id="online_payment_form">
                                    @guest
                                        <div class="text-center mt-20">
                                            <a href="{{ route('login', ['redirect' => 'store.checkout']) }}"
                                                class="btn btn-warning">{{ __('Login to Checkout') }}</a>
                                        </div>
                                    @else
                                        <div class="py-4 px-3">
