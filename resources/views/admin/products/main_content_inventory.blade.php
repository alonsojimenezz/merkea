                        ...
                        @foreach ($product->units['available'] as $unit)
                            @if (in_array($unit->Id, $product->units['assigned']))
                                <div class="row py-2 border-bottom border-warning">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" data-unit="{{ $unit->Id }}"
                                            class="form-control form-control-sm product_stock"
                                            value="{{ $product->stock[$unit->Id]->Quantity ?? 0 }}"
                                            name="product_stock_[{{ $unit->Id }}]"
                                            id="product_stock_[{{ $unit->Id }}]" min="0" / />
                                    </div>
                                </div>
                            @endif
                        @endforeach
                ...
                <table id="product_movements_table"
                    ...
                    <thead class="fs-7 text-gray-400 text-uppercase">
                        <tr>
                            ...
                            <th class="min-w-125px">{{ __('Unit') }}</th>
