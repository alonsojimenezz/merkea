<form id="new_product_form" class="form" action="#">
    <div class="d-flex flex-column mb-8 fv-row">
        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
            <span class="required">{{ __('Product Key') }}</span>
            <span class="svg-icon ms-2" data-bs-toggle="tooltip"
                title="{{ __('The product key must be unique. It is usually used as a barcode') }}">
        ...
        <input id="product_key" name="product_key" type="text" class="form-control form-control-solid"
            placeholder="{{ __('00000000001') }}">
    </div>
    <div class="d-flex flex-column mb-8 fv-row">
        <label class="d-flex align-items-center fs-6 fw-bold mb-2">
